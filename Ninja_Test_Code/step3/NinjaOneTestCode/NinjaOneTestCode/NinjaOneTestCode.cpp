// NinjaOneTestCode.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
T checkIfPositive(const U& u, const int& param1, const int& param2, int param3 = 0, int paramN = 0)
{
